    ...
    <div className="flex flex-col gap-16 md:gap-24 pb-16">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="text-center max-w-2xl mx-auto mb-10">
          ...
          <h2 className="text-2xl sm:text-4xl font-extrabold text-zinc-900 dark:text-white tracking-tight mb-3">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="relative rounded-3xl overflow-hidden p-8 sm:p-12 md:p-16 border border-purple-500/30 bg-gradient-to-br from-slate-100 via-purple-50 to-slate-100 dark:from-zinc-950 dark:via-purple-950/40 dark:to-zinc-950 shadow-2xl shadow-purple-200/60 dark:shadow-purple-950/30 text-center">
          <div className="absolute -right-20 -bottom-20 w-80 h-80 bg-purple-500/10 dark:bg-purple-600/20 rounded-full blur-[100px] pointer-events-none" />
          <div className="absolute -left-20 -top-20 w-80 h-80 bg-indigo-500/10 dark:bg-indigo-600/20 rounded-full blur-[100px] pointer-events-none" />

          <div className="relative z-10 max-w-2xl mx-auto space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-500/15 border border-purple-500/30 text-purple-600 dark:text-purple-300 text-xs font-semibold">
