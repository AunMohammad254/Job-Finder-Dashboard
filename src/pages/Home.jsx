...
export default function Home() {
  ...
  return (
    <div className="flex flex-col gap-16 md:gap-24 pb-16">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="relative rounded-3xl overflow-hidden p-8 sm:p-12 md:p-16 border border-purple-500/30 bg-linear-to-br from-slate-100 via-purple-50 to-slate-100    shadow-2xl shadow-purple-200/60  text-center">
          ...
          <div className="relative z-10 max-w-2xl mx-auto space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-500/15 border border-purple-500/30 text-purple-600  text-xs font-semibold">
