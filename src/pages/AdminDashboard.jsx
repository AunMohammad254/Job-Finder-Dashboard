...
export default function AdminDashboard() {
  ...
  const [activeTab, setActiveTab] = useState('applications'); // 'applications' | 'jobs' | 'analytics'
  ...
  const metrics = useMemo(() => {
    ...
    return { totalApps, pending, underReview, interviewing, accepted, totalJobsCount };
  ...
  // Helper for candidate avatar initials
  ...
  // If not unlocked, render the Auth gate with coming soon notice
  if (!isUnlocked) {
    return (
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-3.5 sm:gap-4 mb-8">
        <div className="p-4 sm:p-5 rounded-2xl bg-zinc-900/80 border border-zinc-800 shadow-lg">
          ...
          <div className="text-[11px] text-zinc-400 mt-1">Across all listings</div>
        </div>
        ...
        <div className="p-4 sm:p-5 rounded-2xl bg-zinc-900/80 border border-zinc-800 shadow-lg">
          ...
          <div className="text-[11px] text-zinc-400 mt-1">Published listings</div>
        </div>
        ...
        <div className="p-4 sm:p-5 rounded-2xl bg-zinc-900/80 border border-zinc-800 shadow-lg">
          ...
          <div className="text-[11px] text-zinc-400 mt-1">Requires action</div>
        </div>
        ...
        <div className="p-4 sm:p-5 rounded-2xl bg-zinc-900/80 border border-zinc-800 shadow-lg">
          ...
          <div className="text-[11px] text-zinc-400 mt-1">Scheduled calls</div>
        </div>

        <div className="col-span-2 lg:col-span-1 p-4 sm:p-5 rounded-2xl bg-zinc-900/80 border border-zinc-800 shadow-lg">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs font-medium text-zinc-400 uppercase tracking-wider">
              Accepted / Hired
            </span>
          ...
          <div className="text-[11px] text-zinc-400 mt-1">Offers accepted</div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 border-b border-zinc-800 pb-3 mb-6">
        ...
        >
          ...
          <span>Manage Jobs ({jobsList.length})</span>
        </button>
      ...
      {activeTab === 'applications' && (
        <div className="space-y-6">
          {/* Filter / Search Bar */}
          <div className="relative z-30 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 p-4 rounded-2xl bg-zinc-900/70 border border-zinc-800 shadow-md">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full bg-zinc-950/80 border border-zinc-700/60 rounded-xl pl-10 pr-4 py-2.5 text-sm text-white placeholder-zinc-500 focus:outline-none focus:border-purple-500"
              />
            </div>
            ...
            <div className="flex items-center gap-3">
              <Dropdown
                ...
                triggerClassName="py-2 bg-zinc-950 border-zinc-700/60 text-xs sm:text-sm"
              />
            </div>
          </div>
          ...
          {filteredApplications.length > 0 ? (
            <div className="relative z-10 bg-zinc-900/80 border border-zinc-800 rounded-2xl overflow-hidden shadow-xl">
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-5 py-4">
                            <div className="flex items-center gap-3">
                              <div className="w-10 h-10 rounded-xl bg-purple-600/20 border border-purple-500/30 flex items-center justify-center font-bold text-xs text-purple-300 flex-shrink-0">
                          ...
                          <td className="px-5 py-4 text-right space-x-2">
                            <button
                              ...
                              className="px-3 py-1.5 rounded-lg bg-zinc-800 text-zinc-300 hover:text-white hover:bg-zinc-700 text-xs font-medium transition-colors cursor-pointer"
                            >
                              Details
                            </button>
                            <button
                              ...
                              className="p-1.5 rounded-lg text-rose-400 hover:text-rose-200 hover:bg-rose-950/40 transition-colors cursor-pointer inline-flex items-center"
            ...
            <div className="text-center py-16 px-4 rounded-2xl bg-zinc-900/40 border border-zinc-800/80 border-dashed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {jobsList.map((job) => {
              ...
              return (
                <div
                  key={job.id}
                  className="p-5 rounded-2xl bg-zinc-900/80 border border-zinc-800 flex flex-col justify-between gap-4"
                >
                  <div>
                    <div className="flex items-start justify-between gap-3 mb-2">
                      <div>
                        <span className="text-[11px] font-semibold px-2.5 py-0.5 rounded-full bg-purple-500/15 text-purple-300 border border-purple-500/30">
                          {job.jobType}
                        </span>
                      ...
                      <span className="px-2.5 py-1 rounded-xl bg-zinc-800 text-xs font-semibold text-purple-300 border border-zinc-700">
            ...
            <div className="p-6 rounded-2xl bg-zinc-900/80 border border-zinc-800">
              ...
              <div className="space-y-4">
                {[
                  ...
                  return (
                    <div key={exp} className="flex items-center justify-between p-3 rounded-xl bg-zinc-950/60 border border-zinc-800/80">
                      <span className="text-xs text-zinc-300 font-medium">{exp}</span>
                      <span className="text-xs font-bold text-purple-400 px-2 py-0.5 rounded-md bg-purple-500/10">
                        {count} candidates
                      </span>
                    </div>
                  );
      ...
      {selectedApp && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fadeIn">
          <div className="relative w-full max-w-lg bg-zinc-900 border border-zinc-700 rounded-3xl p-6 sm:p-8 shadow-2xl shadow-purple-950/60 max-h-[90vh] overflow-y-auto">
            <button
              type="button"
            ...
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-xs text-zinc-400">{selectedApp.applicantEmail}</p>
            ...
            <div className="space-y-4 text-xs sm:text-sm text-zinc-300">
              <div className="p-3.5 rounded-xl bg-zinc-950 border border-zinc-800 space-y-1">
                ...
                <div className="font-semibold text-white">{selectedApp.jobTitle}</div>
                <div className="text-xs text-zinc-400">{selectedApp.company} • Submitted on {selectedApp.appliedDate}</div>
              </div>
              ...
              <div className="p-3.5 rounded-xl bg-zinc-950 border border-zinc-800 space-y-1">
                ...
                <div className="text-zinc-200">{selectedApp.experienceLevel || 'Not specified'}</div>
              </div>
              ...
              <div className="p-3.5 rounded-xl bg-zinc-950 border border-zinc-800 space-y-1">
                ...
                {selectedApp.applicantResume && selectedApp.applicantResume.startsWith('http') ? (
                  <a
                    href={selectedApp.applicantResume}
                    target="_blank"
                    rel="noreferrer"
                  ...
                  <div className="text-zinc-400">{selectedApp.applicantResume || 'None provided'}</div>
                )}
              </div>
              ...
              {selectedApp.notes && (
                <div className="p-3.5 rounded-xl bg-zinc-950 border border-zinc-800 space-y-1">
                  ...
                  <p className="text-xs text-zinc-300 leading-relaxed">{selectedApp.notes}</p>
                </div>
              )}
            ...
            <div className="mt-8 flex items-center justify-between gap-3 pt-4 border-t border-zinc-800">
              <a
      ...
      {showPostJobModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fadeIn">
          <div className="relative w-full max-w-lg bg-zinc-900 border border-zinc-700 rounded-3xl p-6 sm:p-8 shadow-2xl shadow-purple-950/60 max-h-[90vh] overflow-y-auto">
            ...
            <div className="mb-6">
              <h2 className="text-xl font-bold text-white">Create New Job Opening</h2>
            ...
            <form onSubmit={handleCreateJob} className="space-y-4 text-sm">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Lead Next.js Developer"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2.5 rounded-xl bg-zinc-950 border border-zinc-700 text-white focus:outline-none focus:border-purple-500"
                  >
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. PKR 180,000 - 260,000"
                  className="w-full px-4 py-2.5 rounded-xl bg-zinc-950 border border-zinc-700 text-white placeholder-zinc-500 focus:outline-none focus:border-purple-500"
                />
              </div>
