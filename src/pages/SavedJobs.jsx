...
export default function SavedJobs() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      {savedCount > 1 && (
        <div className="relative z-30 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 mb-6 p-3 rounded-2xl bg-zinc-900/60 border border-zinc-800/80 backdrop-blur-md">
          ...
          {selectedType && (
            <button
              ...
              className="text-xs text-purple-400 hover:text-purple-300 transition-colors self-start sm:self-auto px-2 py-1 cursor-pointer"
            >
              Clear filter
            </button>
          )}
