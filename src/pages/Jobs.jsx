    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <div className="mb-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            <div className="inline-flex items-center gap-2 text-xs font-semibold text-purple-500  uppercase tracking-wider mb-2">
          ...
          <div className="flex items-center gap-2 text-xs text-zinc-500  font-medium bg-white  px-3.5 py-2 rounded-xl border border-slate-200  shadow-sm  self-start md:self-auto">
            <span>
              Showing <strong className="text-purple-600  font-bold">{filteredJobs.length}</strong> of {jobs.length} roles
            </span>
          </div>
        </div>
      </div>
            ...
            <button
              ...
              className={`flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs sm:text-sm font-medium whitespace-nowrap transition-all duration-200 cursor-pointer ${
                isSelected
                  ...
                  : 'bg-white  hover:bg-slate-100 :bg-zinc-800/80 text-zinc-600  hover:text-zinc-900 :text-white border border-slate-200  shadow-sm '
              }`}
            >
      ...
      <div className="relative z-30 p-4 sm:p-6 rounded-2xl bg-white  border border-slate-200  backdrop-blur-xl mb-8 space-y-4 shadow-lg shadow-slate-200/80 ">
        <div className="relative z-20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-4 items-end">
          {/* Search bar */}
          <div className="sm:col-span-2 lg:col-span-5">
            <label className="text-xs font-semibold text-zinc-500  uppercase tracking-wider mb-1.5 flex items-center gap-1.5">
        ...
        {/* Active Filters bar */}
        {hasActiveFilters && (
          <div className="relative z-10 pt-3 border-t border-slate-200  flex flex-wrap items-center justify-between gap-3 text-xs">
            <div className="flex flex-wrap items-center gap-2 text-zinc-500 ">
              ...
              {searchTerm && (
                <span className="px-2.5 py-1 rounded-full bg-purple-500/10 border border-purple-500/30 text-purple-600 ">
                  Keyword: &quot;{searchTerm}&quot;
                </span>
              )}
              {selectedType && (
              ...
              {selectedCategory && (
                <span className="px-2.5 py-1 rounded-full bg-purple-500/10 border border-purple-500/30 text-purple-600  capitalize">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg text-xs text-rose-600  hover:text-rose-700 :text-rose-300 hover:bg-rose-50 :bg-rose-950/40 border border-rose-200  transition-colors cursor-pointer"
            >
